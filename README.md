...
A complete real-time classroom polling and attendance system built with **FastAPI** (Python) and **Next.js** (TypeScript).
...
└── frontend/                # Next.js 14 App Router frontend
    ...
    ├── components/
    │   ├── professor/  SessionPanel, PollPanel, AttendancePanel, ResultsPanel
...
`npm run dev` binds to all interfaces so phones can connect via your Mac's IP.

### Join from a phone (same Wi‑Fi)

1. Find your Mac's IP: `ipconfig getifaddr en0` (e.g. `192.168.1.89`)
2. Start backend with `--host 0.0.0.0` (see above)
3. On your phone, open: `http://YOUR_MAC_IP:3000/student`
